...
# major revision : unused options by version
options_that_are_not_used_v1 = as.data.frame(setdiff(compose_file_version1_features$feature, unique(compose_file_features[which(compose_file_features$version=="" | compose_file_features$version=="n"),]$feature)))
nrow(options_that_are_not_used_v1)/nrow(compose_file_version1_features)


options_that_are_not_used_v2 = as.data.frame(setdiff(compose_file_version2_features$feature, unique(compose_file_features[grep("^2",compose_file_features$version),]$feature)))
nrow(options_that_are_not_used_v2)/nrow(compose_file_version2_features)

options_that_are_not_used_v3 = as.data.frame(setdiff(compose_file_version3_features$feature, unique(compose_file_features[grep("^3",compose_file_features$version),]$feature)))
nrow(options_that_are_not_used_v3)/nrow(compose_file_version3_features)
